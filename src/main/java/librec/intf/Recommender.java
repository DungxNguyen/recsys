		...
		if (isRankingPred) {
			if (isDiverseUsed)
				evalInfo = String.format("%.6f,%.6f,%.6f,%.6f,%.6f,%.6f,%.6f,%.6f,%.6f,%.6f,%.6f,%.6f",
						measures.get(Measure.Pre2),measures.get(Measure.Pre5), measures.get(Measure.Pre10),
						measures.get(Measure.Rec2),measures.get(Measure.Rec5), measures.get(Measure.Rec10), 
						measures.get(Measure.AUC), measures.get(Measure.MAP),
